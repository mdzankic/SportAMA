...
<head>
	...
	<link rel = "stylesheet" type = "text/css" href = "dist/css/sAMA.css">
...
<div class="zag">
	<header>
         <table cellspacing="50" width="100%">
			<thead>
			<th><img src="dist/img/logo.jpg" width="300" height="150"></th>
	...
	<div>
		...
		<div class="container">
			<img style="width:840px" src="dist/img/naslovna.png" alt="Naslovna">
				<div class="content">
...
<div class="gallery" id="m__admin">
	<a target="_blank" href="dist/img/Ana.jpg">
		<img style=" height: 270px; width: 230px;" src="dist/img/Ana.jpg" alt="Ana Ljubić slika">
	</a>
	<div class="desc">
...
<div class = "gallery">
	<a target="_blank" href="dist/img/AnaB.jpg"> 
		<img style=" height: 240px; width: 300px;" src="dist/img/AnaB.jpg" alt="Ana Braovac slika"> 
	</a>
	<div class="desc">
...
<div class="gallery">
	<a target="_blank" href="dist/img/Matea.jpg">
		<img style=" height: 290px; width: 180px;" src="dist/img/Matea.jpg" alt="Matea Džankić slika">
	</a>
	<div class="desc">
